...
from src import api, db, ma, create_app, configs, bp, security, celery, serializer_helper, sentry,\
...
extensions = [api, db, ma, security, celery, serializer_helper, sentry, redis_store,
